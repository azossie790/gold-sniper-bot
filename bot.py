...
def analyse_full(df_m15, df_h1, df_h4, news_mode=False):
    """
    Score sur 100 pts. Signal si score >= MIN_CONFLUENCE%.
    ...
    entry = price
    sl = round(df_m15["low"].iloc[-5:].min()-atr_val*0.3,2) if direction=="BUY" \
         else round(df_m15["high"].iloc[-5:].max()+atr_val*0.3,2)
...
class GoldSniperBot:
    ...
    async def run(self):
        ...
        await self.send(
            ...
            "━━━━━━━━━━━━━━━━━━━━━━━━\n"
            "✅ Analyse multi-confluence 12 systèmes\n"
            "✅ Liquidité | SMC | Order Flow\n"
    ...
    async def _try_signal(self, price, news_mode=False, news_name=""):
        ...
        result = analyse_full(df_m15, df_h1, df_h4, news_mode=news_mode)
